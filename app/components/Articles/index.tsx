...
const postData: DataType[] = [
    {
        time: "5 min",
        heading: 'Decentralised the Data',
        heading2: 'We Start Work on Digital Legacy',
    ...
    {
        time: "5 min",
        heading: 'We Launch Health Assistant',
    ...
    {
        time: "5 min",
        heading: 'Learning Language Start',
        heading2: 'Working on it',
        name: "-",
        date: '-',
        imgSrc: '/images/articles/article2.png',
    },
